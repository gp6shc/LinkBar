		...
		<div class="LB-admin-interior">
			...
			<h3>Icon Styles</h3>
				 <form method="POST" action="">
						...
						<!--<p>The secondary background color is switched to when the icon is hovered.<br/>The secondary fill color is switched to when the icon is hovered.</p>
                       
                        <label for="fb-secondarycolor">
                           <h4>Facebook's Secondary Background Color:
							   <input type="text" name="fb-secondarycolor" size="8" /></h4>
                        </label> 
                       
                        <label for="fb-fill-color">
                           <h4>Facebook's Secondary Fill Color:
							   <input type="text" name="fb-fill-color" size="8" /></h4>
                        </label> 
                        <hr/>
                        
                        <label for="twtr-secondarycolor">
                           <h4>Twitter's Secondary Background Color:
							   <input type="text" name="twtr-secondarycolor" size="8" /></h4>
                        </label> 
                       
                        <label for="twtr-fill-color">
                           <h4>Twitter's Secondary Fill Color:
							   <input type="text" name="twtr-fill-color" size="8" /></h4>
                        </label> 
                        <hr/>
                        
                        <label for="gplus-secondarycolor">
                           <h4>Google+'s Secondary Background Color:
							   <input type="text" name="gplus-secondarycolor" size="8" /></h4>
                        </label> 
                       
                        <label for="gplus-fill-color">
                           <h4>Google+'s Secondary Fill Color:
							   <input type="text" name="gplus-fill-color" size="8" /></h4>
                        </label> 
                        <hr/>
                        
                        <label for="li-secondarycolor">
                           <h4>LinkedIn's Secondary Background Color:
	                        <input type="text" name="li-secondarycolor" size="8" /></h4>
                        </label> 
                       
                        <label for="li-fill-color">
                           <h4>LinkedIn's Secondary Fill Color:
							   <input type="text" name="li-fill-color" size="8" /></h4>
                        </label> 
                        <hr/>
                        
                        <label for="pin-secondarycolor">
                           <h4>Pinterest's Secondary Background Color:
							   <input type="text" name="pin-secondarycolor" size="8" /></h4>
                        </label> 
                       
                        <label for="pin-fill-color">
                           <h4>Pinterest's Secondary Fill Color:
							   <input type="text" name="pin-fill-color" size="8" /></h4>
                        </label> 
                        <hr/>
                        
                        <label for="tumb-secondarycolor">
                           <h4>Tumblr's Secondary Background Color:
							   <input type="text" name="tumb-secondarycolor" size="8" /></h4>
                        </label> 
                       
                        <label for="tumb-fill-color">
                           <h4>Tumblr's Secondary Fill Color:
							   <input type="text" name="tumb-fill-color" size="8" /></h4>
                        </label> 
                        <hr/>
                        
                        <label for="redd-secondarycolor">
                           <h4>Reddit's Secondary Background Color:
							   <input type="text" name="redd-secondarycolor" size="8" /></h4>
                        </label> 
                       
                        <label for="redd-fill-color">
                           <h4>Reddit's Secondary Fill Color:
							   <input type="text" name="redd-fill-color" size="8" /></h4>
                        </label> 
                        <hr/>
                        
                        <label for="stum-secondarycolor">
                           <h4>Stumblupon's Secondary Background Color:
							   <input type="text" name="stum-secondarycolor" size="8" /></h4>
                        </label> 
                       
                        <label for="stum-fill-color">
                           <h4>Stumblupon's Secondary Fill Color:
							   <input type="text" name="stum-fill-color" size="8" /></h4>
                        </label> 
                        <hr/>
                        
                        <label for="email-secondarycolor">
                           <h4>Email's Secondary Background Color:
							   <input type="text" name="email-secondarycolor" size="8" /></h4>
                        </label> 
                       
                        <label for="email-fill-color">
                           <h4>Email's Secondary Fill Color:
							   <input type="text" name="email-fill-color" size="8" /></h4>
                        </label> 
                        <hr/>
                        
                        <label for="url-secondarycolor">
                           <h4>URL's Secondary Background Color:
							   <input type="text" name="url-secondarycolor" size="8" /></h4>
                        </label> 
                       
                        <label for="url-fill-color">
                           <h4>URL's Secondary Fill Color:
							   <input type="text" name="url-fill-color" size="8" /></h4>
                        </label>-->

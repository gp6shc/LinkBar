...
<style> 
	...
	.LB-reddit:hover .LB-reddit-body {
	  fill: black;
	}
...
<?php
	...
	foreach( $links as $service ) {
		switch($service) {
			...
			break;
			case('twitter'):
				echo '<a class="LB LB-twitter" href="https://twitter.com/share?url='.$thePermalink.'" target="_blank" title="Share on Twitter">
			...
			case('email'):
				echo '<a href="mailto:?subject='.urldecode($thePageTitle).'&body='.$thePageExcept.'%0A%0A'.$thePermalink.'" class="LB LB-email" title="Share by email">
						<svg width="100%" height="'.$icon_scale.'%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 57" >
